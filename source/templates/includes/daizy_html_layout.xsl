<xsl:stylesheet 
	...
	<xsl:template match="head_css">
		...
		<link rel="stylesheet" href="assets/vendor/fontawesome-free-5.7.2-web/css/all.css"/>
		<xsl:value-of select="php:function('\Daizy\SiteBuildHelper::copyDirectory', 'assets/vendor/fontawesome-free-5.7.2-web')"/>
