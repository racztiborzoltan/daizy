<xsl:stylesheet 
	...
	<xsl:template name="dashboard_menu_content__dashboard">
		<div class="card bg-light mt-3 menu-content">
			<xsl:variable name="collapse_id" select="php:function('uniqid', 'id_')"></xsl:variable>
			<xsl:variable name="collapse_caption" select="'Dashboard'"></xsl:variable>
			...
			<div id="{$collapse_id}" class="collapse">
				<div class="card-body">
					<h3>Daizy Minimalistic Admin Template</h3>
